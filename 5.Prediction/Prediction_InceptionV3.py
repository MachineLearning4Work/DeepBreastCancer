...
#checkpoints_path = '/home/habibzadeh/Desktop/BC_malignant_checkpoints/inception_v3'

#checkpoints path of fine-tunning all layers
checkpoints_path = '/home/habibzadeh/Desktop/BC_malignant_checkpoints/inception_v3/all/'
...
with tf.Graph().as_default():
    ...
    with slim.arg_scope(inception.inception_v3_arg_scope()):
        logits, _ = inception.inception_v3(processed_images, num_classes=4, is_training=False)
