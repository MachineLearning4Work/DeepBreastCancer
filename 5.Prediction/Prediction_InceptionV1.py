...
checkpoints_path = '/home/douranml/Desktop/BC_malignant_ckpt_v1/inception_v1/all'
...
with tf.Graph().as_default():
    ...
    with slim.arg_scope(inception.inception_v1_arg_scope()):
        logits, _ = inception.inception_v1(processed_images, num_classes=4, is_training=False)
